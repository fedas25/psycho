                    ...
                    <div style={{ position: "relative" }}>
                        ...
                        <div className={cn(styles.advantages, { [styles.show]: numderAcardionActive >= 2 })}>
                            ...
                            <div className={styles.trainingItem}>
                                ...
                                <p className={cn(styles.accordion, { [styles.accordionActive]: numderAcardionActive < 3 }, "text1")}>
                            ...
                            <div className={styles.trainingItem}>
                                ...
                                <p className={cn(styles.accordion, { [styles.accordionActive]: numderAcardionActive === 4 }, "text1")}>
